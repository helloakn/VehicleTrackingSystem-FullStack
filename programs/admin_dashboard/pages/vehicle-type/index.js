...
function OwnerPage({ query }) {
  ...
  useEffect(() => {
    ...
    const _url = publicRuntimeConfig.NEXT_PUBLIC_ApiDomain + "vehicletype";
    setLoading(true);
  ...
  if (isLoading) return(
    <DashboardLayout 
        ...
        pageName={<div><i className="fas fa-cubes"></i><label>Vehicle Type : List</label></div>}
  ...
  return (
    <DashboardLayout 
        ...
        pageName={<div style={{display:"flex",alignItems: 'center',justifyContent: 'center'}}>
          ...
          <label>Vehicle Type : List</label></div>}
        buttons={
          <div>
            <Link href="vehicle-type/new">
      ...
      <div className={styles.mainContainer}>
       <div className={styles.mainInnerContainer}>
          <div className={styles.paginationContainer}>
            <Pagination paginate={paginate} styles={styles} root={"/vehicle-type/"} page_at={paginate.page_at} />
          </div>
